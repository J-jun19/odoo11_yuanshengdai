...
class ResPartner(models.Model):
    ...
    buyer_code_ids = fields.One2many("res.partner.buyer_code.line", 'partner_id', string="Buyer Code")# 被选择后不能再被其他partner选择
    source_code_ids = fields.One2many("res.partner.source_code.line", 'partner_id', string="Source Code")# 被选择后不能再被其他partner选择
...
class ResPartnerBuyerCodeLine(models.Model):
    _name = "res.partner.buyer_code.line"
...
class ResPartnerSourceCodeLine(models.Model):
    _name = "res.partner.source_code.line"
