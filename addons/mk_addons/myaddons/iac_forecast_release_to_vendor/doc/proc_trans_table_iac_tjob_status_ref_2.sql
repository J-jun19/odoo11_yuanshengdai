-- FUNCTION: ep_temp_master.proc_trans_table_iac_tjob_status_ref_2(character varying, integer, integer, integer, integer, integer)

-- DROP FUNCTION ep_temp_master.proc_trans_table_iac_tjob_status_ref_2(character varying, integer, integer, integer, integer, integer);
/*
...
*/
CREATE OR REPLACE FUNCTION ep_temp_master.proc_trans_table_iac_tjob_status_ref_2(
...
ALTER FUNCTION ep_temp_master.proc_trans_table_iac_tjob_status_ref_2(character varying, integer, integer, integer, integer, integer)
    OWNER TO openerp;
