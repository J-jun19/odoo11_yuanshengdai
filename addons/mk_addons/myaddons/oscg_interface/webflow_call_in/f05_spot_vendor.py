...
class WebCallOutWebflowF05(models.AbstractModel):
    _name = 'web.call.in.webflow.f05'
    _inherit="webflow.call.in.base"
    _description = "Web Call In Webflow F05 Interface"
    ...
    def invoke_biz_mothod(self,context=None):
        ...
        :return:
        """
        odoo_model_name="iac.spot.vendor"
        proc_context={
        ...
        proc_ex=[]
        try:
            proc_result,proc_ex=self.env[odoo_model_name].vendor_spot_register_callback(proc_context)
        except:
