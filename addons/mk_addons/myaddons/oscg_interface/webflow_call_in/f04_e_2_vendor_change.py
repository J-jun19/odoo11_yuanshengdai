...
class WebCallOutWebflowF04(models.AbstractModel):
    _name = 'web.call.in.webflow.f04_e_2'
    ...
    def invoke_biz_mothod(self,context=None):
        ...
        :return:
        """
        odoo_model_name="iac.vendor.block"
        proc_context={
        ...
        proc_ex=[]
        try:
            proc_result,proc_ex=self.env[odoo_model_name].vendor_block_unblock_callback(proc_context)
        except:
