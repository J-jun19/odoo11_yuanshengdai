...
class WebCallOutWebflowF07(models.AbstractModel):
    _name = 'web.call.in.webflow.f07_e_1'
    _inherit="webflow.call.in.base"
    _description = "Web Call In Webflow F07 po new Interface"
    ...
    def invoke_biz_mothod(self,context=None):
        ...
        :return:
        """
        odoo_model_name="iac.purchase.order"
        proc_context={
        ...
        proc_ex=[]
        try:
            proc_result,proc_ex=self.env[odoo_model_name].po_new_callback(proc_context)
        except:
