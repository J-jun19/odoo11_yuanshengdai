...
class WebCallOutWebflowF03(models.AbstractModel):
    _name = 'web.call.in.webflow.f03'
    _inherit="webflow.call.in.base"
    _description = "Web Call In Webflow F03 Interface"
    ...
    def invoke_biz_mothod(self,context=None):
        ...
        :return:
        """
        odoo_model_name="iac.vendor.copy"
        proc_context={
        ...
        proc_ex=[]
        try:
            proc_result,proc_ex=self.env[odoo_model_name].vendor_copy_callback(proc_context)
        except:
