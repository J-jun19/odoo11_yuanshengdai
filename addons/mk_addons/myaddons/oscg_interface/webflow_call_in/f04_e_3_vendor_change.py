...
class WebCallOutWebflowF04(models.AbstractModel):
    _name = 'web.call.in.webflow.f04_e_3'
    ...
    def invoke_biz_mothod(self,context=None):
        ...
        :return:
        """
        odoo_model_name="iac.vendor.change.terms"
        proc_context={
        ...
        proc_ex=[]
        try:
            proc_result,proc_ex=self.env[odoo_model_name].vendor_change_payment_incoterm_callback(proc_context)
        except:
