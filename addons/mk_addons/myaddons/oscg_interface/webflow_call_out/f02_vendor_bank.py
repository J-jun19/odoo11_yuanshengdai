...
class WebCallOutWebflowF02(models.AbstractModel):
    _name = 'web.call.out.webflow.f02'
    ...
    def generate_json(self,context=None):
        exeception_log=[]
        json_data,exeception_log=super(WebCallOutWebflowF02,self).generate_json(context)
    ...
    def invoke_web_call_from_json_with_log(self,context=None):
        ...
        log_line_id=0
        exception_list=[]
        rpc_result,rpc_json_data,log_line_id,exception_list=super(WebCallOutWebflowF02,self).invoke_web_call_from_json_with_log(context)
