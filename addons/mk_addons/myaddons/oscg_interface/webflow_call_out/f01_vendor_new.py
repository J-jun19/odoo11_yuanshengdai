...
class WebCallOutWebflowF01(models.AbstractModel):
    _name = 'web.call.out.webflow.f01'
    ...
    def generate_json(self,context=None):
        exeception_log=[]
        json_data,exeception_log=super(WebCallOutWebflowF01,self).generate_json(context)
    ...
    def invoke_web_call_from_json_with_log(self,context=None):
        ...
        log_line_id=0
        exception_list=[]
        rpc_result,rpc_json_data,log_line_id,exception_list=super(WebCallOutWebflowF01,self).invoke_web_call_from_json_with_log(context)
