...
import traceback
class WebCallOutSapVendor003(models.AbstractModel):
    _name = 'web.call.out.sap.vendor.003'
    ...
    def invoke_web_call_with_log(self,context=None):
        ...
        exception_log=[]
        log_line_id=0
        json_data,exception_log=super(WebCallOutSapVendor003,self).generate_json(context)
        context["json_params"]=json_data
        rpc_result,rpc_data,log_line_id,exception_log=super(WebCallOutSapVendor003,self).invoke_web_call_with_log(context)
