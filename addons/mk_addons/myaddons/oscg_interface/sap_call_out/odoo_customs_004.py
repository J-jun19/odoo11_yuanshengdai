...
class WebCallOutSapCustoms004(models.AbstractModel):
    _name = 'web.call.out.sap.customs.004'
    _inherit="sap.call.out.base"
    _description = "Web Call Out Sap ODOO_CUSTOMS_004 Interface"
    ...
    def invoke_web_call_with_log(self,context=None):
        ...
        exception_log=[]
        log_line_id=0
        json_data,exception_log=super(WebCallOutSapCustoms004,self).generate_json(context)
        context["json_params"]=json_data
        rpc_result,rpc_data,log_line_id,exception_log=super(WebCallOutSapCustoms004,self).invoke_web_call_with_log(context)
