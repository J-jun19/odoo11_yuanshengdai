...
class WebCallOutSapRfq001(models.AbstractModel):
    _name = 'web.call.out.sap.rfq.001'
    ...
    def invoke_web_call_with_log(self,context=None):
        ...
        exception_log=[]
        log_line_id=0
        json_data,exception_log=super(WebCallOutSapRfq001,self).generate_json(context)
        context["json_params"]=json_data
        rpc_result,rpc_data,log_line_id,exception_log=super(WebCallOutSapRfq001,self).invoke_web_call_with_log(context)
